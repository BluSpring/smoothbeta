...
public class VertexFormats {
   ...
   public static final VertexFormatElement LIGHT_ELEMENT = new VertexFormatElement(1, VertexFormatElement.ComponentType.SHORT, VertexFormatElement.Type.UV, 2);
   ...
   public static final VertexFormat POSITION_TEXTURE_COLOR_NORMAL_LIGHT = new VertexFormat(ImmutableMap.<String, VertexFormatElement>builder()
       .put("Position", POSITION_ELEMENT)
       .put("UV0", TEXTURE_0_ELEMENT)
       .put("Color", COLOR_ELEMENT)
       .put("Normal", NORMAL_ELEMENT)
       .put("UV1", LIGHT_ELEMENT)
